...
This family defines the standard realization topology for `odd_method`.
...
`odd_method` keeps shared realization law and tenant-local realization law in explicit
separate surfaces.

**Acceptance Criteria**:
- AC-1: `build_tenants/common/` exists as the shared realization root
