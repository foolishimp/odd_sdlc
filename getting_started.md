...
│   ├── docs/
│   └── release_snapshots/abiogenesis-typescript-tenant/3.9.0-rc.6/
...
```bash
ls "$APPS"/abiogenesis/release_snapshots/abiogenesis-typescript-tenant/3.9.0-rc.6/abiogenesis-typescript-tenant-3.9.0-rc.6.tgz
...
```bash
ls "$APPS"/abiogenesis/release_snapshots/abiogenesis-typescript-tenant/3.9.0-rc.6/release-snapshot-manifest.json
ls "$APPS"/abiogenesis/release_snapshots/abiogenesis-typescript-tenant/3.9.0-rc.6/checksums.sha256
ls "$APPS"/abiogenesis/release_snapshots/abiogenesis-typescript-tenant/3.9.0-rc.6/abiogenesis-typescript-tenant-3.9.0-rc.6.tgz
```
...
```text
@abiogenesis/typescript-tenant@3.9.0-rc.6
```
...
> reports version `3.9.0-rc.6` and that
...
dependency is installed from the ABIogenesis `3.9.0-rc.6` release snapshot, so
