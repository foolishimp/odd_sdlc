...
export const ODD_SDLC_ABIOGENESIS_SUBSTRATE_CONTRACT = Object.freeze({
  ...
  sourceAssumptions: Object.freeze([
    ...
    "ABIogenesis T-125 temporal and non-temporal GTL live lanes remain regression inputs carried by 4.1.0-rc.1",
    "ABIogenesis T-127 publishes the F_P construction evaluator and read-only public gaps ranking substrate carried by 4.1.0-rc.1",
    "ABIogenesis T-129 publishes the runtime system probe observer liveness substrate carried by 4.1.0-rc.1",
    "ABIogenesis T-144/T-145/T-146 publish the staged compute substrate for transform.C, evaluate.C, consequence.C, evaluation sets, and composed stage tasks carried by 4.1.0-rc.1",
    "ABIogenesis T-147 publishes replay-derived retry context, output authority projection, and target-carrier output admission before closure carried by 4.1.0-rc.1",
    "ABIogenesis T-148 publishes the runtime continuation-transition projection carried by 4.1.0-rc.1",
    "ABIogenesis T-149 publishes the primitive iteration-outcome projection carried by 4.1.0-rc.1",
    "ABIogenesis T-151 publishes segment-scoped evaluation redispatch metadata carried by 4.1.0-rc.1",
    "ABIogenesis T-152 publishes the static GTL program conformance gate, compute-stage binding rows, ABG runtime binding rows, repair-surface triage binding, and graph-vector reentry application carried by 4.1.0-rc.1",
    "ABIogenesis T-154 publishes runtime authorship routes for explicit graph-vector resume cursor and graph-span reentry consumption carried by 4.1.0-rc.1",
    "ABIogenesis T-155 publishes GTL graph-function zoom planning and application carried by 4.1.0-rc.1",
    "ABIogenesis T-156 publishes the consequence allowed traversal catalog, runtime catalog gate, and static GTL annotation validation carried by 4.1.0-rc.1",
    "ABIogenesis T-157 publishes runtime start traversal selection for run-scoped dependency windows carried by 4.1.0-rc.1",
    "ABIogenesis T-158 publishes static GTL plugin result-interface validation, the compiler-admitted result-interface catalog, and runner/replay-visible result-envelope ingress for compute-stage outputs carried by 4.1.0-rc.1",
    "ABIogenesis T-159 publishes TraversalUnit<A, B> projection and ratifies consequence as the bind boundary carried by 4.1.0-rc.1"
  ])
} as const);
