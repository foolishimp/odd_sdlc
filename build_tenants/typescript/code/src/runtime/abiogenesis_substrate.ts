...
export const ODD_SDLC_ABIOGENESIS_SUBSTRATE_CONTRACT = Object.freeze({
  ...
  sourceAssumptions: Object.freeze([
    ...
    "ABIogenesis T-125 temporal and non-temporal GTL live lanes remain regression inputs for 3.9.0-rc.9",
    "ABIogenesis T-127 publishes the F_P construction evaluator and read-only public gaps ranking substrate under 3.7.0-rc.1",
    "ABIogenesis T-129 publishes the runtime system probe observer liveness substrate under 3.9.0-rc.9",
    "ABIogenesis T-144/T-145/T-146 publish the staged compute substrate for transform.C, evaluate.C, consequence.C, evaluation sets, and composed stage tasks under 3.9.0-rc.9",
    "ABIogenesis T-147 publishes replay-derived retry context, output authority projection, and target-carrier output admission before closure under 3.9.0-rc.9",
    "ABIogenesis T-148 publishes the runtime continuation-transition projection under 3.9.0-rc.10"
  ])
} as const);
