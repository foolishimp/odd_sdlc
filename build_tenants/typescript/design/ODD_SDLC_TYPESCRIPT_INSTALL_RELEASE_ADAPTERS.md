...
```text
@abiogenesis/typescript-tenant -> file:../../../abiogenesis/release_snapshots/abiogenesis-typescript-tenant/4.0.0-rc.6/abiogenesis-typescript-tenant-4.0.0-rc.6.tgz
```
