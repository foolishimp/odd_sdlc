# odd_sdlc STDO Governance: Coding Build
...
- Code consumes admitted design/test pressure and target carriers; it preserves requirement lineage and does not redefine product intent.
...
- Materialize only contracted product files under the selected ownership boundary.
- Keep one truth: no hidden source surfaces, fallback topology, alias carriers, or bridge authority.
- Execution, closure, and admission remain ABG/system responsibilities unless the selected contract explicitly says otherwise.
