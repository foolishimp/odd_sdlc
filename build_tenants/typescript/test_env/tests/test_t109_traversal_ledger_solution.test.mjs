// Validates: T-109
// Validates: ABG-3.6-traversal-ledger-proof-routing
...
test("T-109 local product-ledger API is retired in favor of the ABG 3.6 semantic-ledger sandbox lane", () => {
  const packageJson = JSON.parse(
    readFileSync(path.join(PACKAGE_ROOT, "package.json"), "utf8")
  );

  assert.equal(
    packageJson.scripts["test:t102-t110:abg36-sandbox"].includes(
      "test_env/sandbox/test_t102_t109_abg36_semantic_ledger_sandbox.test.mjs"
    ),
    true
  );
