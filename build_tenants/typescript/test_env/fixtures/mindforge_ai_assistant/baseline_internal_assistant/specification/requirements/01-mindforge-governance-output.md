...
**Status**: Active
**Derived From**: `T-163 baseline_internal_assistant`
...
For the baseline variant, the projection shall classify the use case as
`riskTier: "moderate"`, `controlPath: "enhanced_review"`, and
