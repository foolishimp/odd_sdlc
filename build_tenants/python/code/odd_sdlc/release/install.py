    ...
    *,
    ...
    return "\n".join(
        (
            ...
            "",
            "`workspace://.genesis/docs/standards/SPEC_METHOD.md` is the governing process constitution for this workspace.",
            "Read that surface before acting.",
            "Imported project authority defines what the project is.",
            "`odd_sdlc` governs how work proceeds over that authority.",
            "GTL/ABG are substrate, not project identity authority.",
            "",
            "This workspace contains a target project governed by `odd_sdlc`.",
            "It is not itself a GTL/ABG project in identity terms.",
            "`odd_sdlc` is the governance/runtime package.",
            "The target project may be imported, partial, stale, or still underdefined.",
            "",
            "## 1. Constitutional Governance",
            "- `workspace://.genesis/docs/standards/SPEC_METHOD.md` defines lawful authority flow, re-entry, closure, and proof discipline",
            "- imported project authority defines what the project is; odd_sdlc governs how work proceeds over that authority",
            "- GTL/ABG substrate guides, copied template history, runtime read models, and operator habit do not outrank `SPEC_METHOD.md` plus imported project authority",
            "- if local guidance conflicts, follow `SPEC_METHOD.md` and the imported project authority surfaces first",
            "",
            ...
            *authority_surface_lines,
            ...
            "",
            "## 5. Start Here",
            f"- inspect the current pipeline state with `PYTHONPATH=.genesis:{INSTALLED_PRODUCT_CODE_ROOT_RELATIVE.as_posix()} python -m odd_sdlc gaps --workspace .`",
