...
Large manifest (~49k chars) on an incremental iteration. This is not a defect — it is the
correct behavior of a system that provides full context to a governed stateful builder. Cost
is a quality concern, not a correctness concern, and does not warrant a requirement change.
