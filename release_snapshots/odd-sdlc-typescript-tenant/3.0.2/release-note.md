# odd_sdlc 3.0.2 Release Note

This is a patch release for the `odd_sdlc` TypeScript tenant v3 line.

## Release Claim

The TypeScript tenant is `@odd-sdlc/typescript-tenant@3.0.2`.
...
The full `test:t181` file was attempted before this patch sequence. It was
stopped after 389 seconds because the Node test process stayed pending without
output; the narrower T-181 cases above cover the affected admission/projection
behavior.
